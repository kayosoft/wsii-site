                                        ...
                                        <div className="col-xl-6">
                                            <div className="up-comming-events__left">
                                                <div className="up-comming-events__content">
                                                    <h3 className="up-comming-events__title">Event for how to become a volunteer</h3>
                                                    <ul className="list-unstyled up-comming-events__details">
                                                        <li>
                                                            <p> <span className="icon-user"></span> John Doe</p>
                                                        </li>
                                                        <li>
                                                            <p> <span className="icon-calendar-1"></span> Sunday, October 12, 2023 at
                                                                10.100 pm
                                                            </p>
                                                        </li>
                                                        <li>
                                                            <p> <span className="icon-place"></span> Nyendo, Masaka</p>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
